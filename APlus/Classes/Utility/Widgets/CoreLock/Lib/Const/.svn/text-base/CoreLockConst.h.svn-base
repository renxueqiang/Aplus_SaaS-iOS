 ...
 *  外环线条颜色：默认
 */
#define CoreLockCircleLineNormalColor rgba(164,164,164,1)


/*
 *  外环线条颜色：选中
 */
#define CoreLockCircleLineSelectedColor rgba(253,152,20,1)


/*
 *  实心圆
 */
#define CoreLockCircleLineSelectedCircleColor rgba(253,152,20,1)


/*
 *  实心圆
 */
#define CoreLockLockLineColor rgba(253,152,20,1)
