                ...
                action:(click)click
{
    ...
    {
        alertView = [[UIAlertView alloc] initWithTitle:title message:message delegate:nil cancelButtonTitle:@"确定" otherButtonTitles: nil];
    }
                      ...
                      action:(click )click
{
    ...
    {
        sheet = [[UIActionSheet alloc] initWithTitle:title delegate:nil cancelButtonTitle:@"确定" destructiveButtonTitle:destructive otherButtonTitles:nil];
    }
...
#pragma mark - *****  UIAlertView TextField
